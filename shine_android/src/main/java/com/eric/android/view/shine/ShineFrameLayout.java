...
//该闪光布局容器修改自facebook的开源项目
package com.eric.android.view.shine;
...
public class ShineFrameLayout extends FrameLayout {
    ...
    public ShineFrameLayout(Context context) {
        this(context, null, 0);
    }

    public ShineFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShineFrameLayout(Context context, AttributeSet attrs, int defStyle) {
